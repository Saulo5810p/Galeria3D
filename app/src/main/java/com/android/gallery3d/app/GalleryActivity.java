...
public final class GalleryActivity extends AbstractGalleryActivity implements OnCancelListener {
    ...
    private static final int REQUEST_MEDIA_PERMISSIONS = 2001;

    private Dialog mVersionCheckDialog;
    private Bundle mPendingSavedInstanceState;
    private boolean mHasStartedState;


    private static String[] getRequiredMediaPermissions() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!hasMediaPermissions()) {
            ...
            ActivityCompat.requestPermissions(
                    this, getRequiredMediaPermissions(), REQUEST_MEDIA_PERMISSIONS);
            return;
        }

        startOrRestoreState(savedInstanceState);
    }

    private void startOrRestoreState(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            getStateManager().restoreFromState(savedInstanceState);
        } else {
            initializeByIntent();
        }
        mHasStartedState = true;
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (hasMediaPermissions()) {
            startOrRestoreState(mPendingSavedInstanceState);
